                ...
                <form action="processa_contato.php" method="POST">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="idade" id="idade" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[var(--cor-primaria)] focus:ring-[var(--cor-primaria)]">
                        </div>
