...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2025 at 08:11 PM
...
,`KEY_READ_HITS` bigint(21)
,`KEY_READ_MISSES` bigint(21)
...
`COLLATION_NAME` varchar(64)
,`CHARACTER_SET_NAME` varchar(32)
,`FULL_COLLATION_NAME` varchar(64)
,`ID` bigint(11)
,`IS_DEFAULT` varchar(3)
);
...
--
-- Stand-in structure for view `KEY_PERIOD_USAGE`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `OPTIMIZER_COSTS`
-- (See below for the actual view)
--
CREATE TABLE `OPTIMIZER_COSTS` (
`ENGINE` varchar(192)
,`OPTIMIZER_DISK_READ_COST` decimal(9,6)
,`OPTIMIZER_INDEX_BLOCK_COPY_COST` decimal(9,6)
,`OPTIMIZER_KEY_COMPARE_COST` decimal(9,6)
,`OPTIMIZER_KEY_COPY_COST` decimal(9,6)
,`OPTIMIZER_KEY_LOOKUP_COST` decimal(9,6)
,`OPTIMIZER_KEY_NEXT_FIND_COST` decimal(9,6)
,`OPTIMIZER_DISK_READ_RATIO` decimal(9,6)
,`OPTIMIZER_ROW_COPY_COST` decimal(9,6)
,`OPTIMIZER_ROW_LOOKUP_COST` decimal(9,6)
,`OPTIMIZER_ROW_NEXT_FIND_COST` decimal(9,6)
,`OPTIMIZER_ROWID_COMPARE_COST` decimal(9,6)
,`OPTIMIZER_ROWID_COPY_COST` decimal(9,6)
);
...
--
-- Stand-in structure for view `PERIODS`
-- (See below for the actual view)
--
...
,`MEMORY_USED` bigint(10)
,`MAX_MEMORY_USED` bigint(10)
,`EXAMINED_ROWS` bigint(10)
,`SENT_ROWS` bigint(10)
,`QUERY_ID` bigint(10)
,`INFO_BINARY` blob
,`TID` bigint(10)
,`TMP_SPACE_USED` bigint(10)
);
...
--
-- Stand-in structure for view `ROCKSDB_CFSTATS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_CFSTATS` (
`CF_NAME` varchar(193)
...
--
-- Stand-in structure for view `ROCKSDB_CF_OPTIONS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_CF_OPTIONS` (
`CF_NAME` varchar(193)
...
--
-- Stand-in structure for view `ROCKSDB_COMPACTION_STATS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_COMPACTION_STATS` (
`CF_NAME` varchar(193)
,`LEVEL` varchar(513)
,`TYPE` varchar(513)
,`VALUE` double
...
--
-- Stand-in structure for view `ROCKSDB_DBSTATS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_DBSTATS` (
`STAT_TYPE` varchar(193)
,`VALUE` bigint(21)
);
...
--
-- Stand-in structure for view `ROCKSDB_DDL`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_DDL` (
`TABLE_SCHEMA` varchar(193)
,`TABLE_NAME` varchar(193)
,`PARTITION_NAME` varchar(193)
,`INDEX_NAME` varchar(193)
,`COLUMN_FAMILY` int(11)
,`INDEX_NUMBER` int(11)
,`INDEX_TYPE` smallint(6)
,`KV_FORMAT_VERSION` smallint(6)
,`TTL_DURATION` bigint(21)
,`INDEX_FLAGS` bigint(21)
,`CF` varchar(193)
...
--
-- Stand-in structure for view `ROCKSDB_DEADLOCK`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_DEADLOCK` (
`DEADLOCK_ID` bigint(21)
,`TIMESTAMP` bigint(21)
,`TRANSACTION_ID` bigint(21)
,`CF_NAME` varchar(193)
,`WAITING_KEY` varchar(513)
,`LOCK_TYPE` varchar(193)
,`INDEX_NAME` varchar(193)
,`TABLE_NAME` varchar(193)
,`ROLLED_BACK` bigint(21)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `ROCKSDB_GLOBAL_INFO`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_GLOBAL_INFO` (
`TYPE` varchar(513)
,`NAME` varchar(513)
,`VALUE` varchar(513)
);
...
--
-- Stand-in structure for view `ROCKSDB_INDEX_FILE_MAP`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_INDEX_FILE_MAP` (
`COLUMN_FAMILY` int(11)
,`INDEX_NUMBER` int(11)
,`SST_NAME` varchar(193)
,`NUM_ROWS` bigint(21)
,`DATA_SIZE` bigint(21)
,`ENTRY_DELETES` bigint(21)
,`ENTRY_SINGLEDELETES` bigint(21)
,`ENTRY_MERGES` bigint(21)
,`ENTRY_OTHERS` bigint(21)
,`DISTINCT_KEYS_PREFIX` varchar(800)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `ROCKSDB_LOCKS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_LOCKS` (
`COLUMN_FAMILY_ID` int(11)
...
--
-- Stand-in structure for view `ROCKSDB_PERF_CONTEXT`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_PERF_CONTEXT` (
`TABLE_SCHEMA` varchar(193)
,`TABLE_NAME` varchar(193)
,`PARTITION_NAME` varchar(193)
,`STAT_TYPE` varchar(193)
...
--
-- Stand-in structure for view `ROCKSDB_PERF_CONTEXT_GLOBAL`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_PERF_CONTEXT_GLOBAL` (
`STAT_TYPE` varchar(193)
,`VALUE` bigint(21)
);
...
--
-- Stand-in structure for view `ROCKSDB_SST_PROPS`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_SST_PROPS` (
`SST_NAME` varchar(193)
,`COLUMN_FAMILY` int(11)
,`DATA_BLOCKS` bigint(21)
,`ENTRIES` bigint(21)
,`RAW_KEY_SIZE` bigint(21)
,`RAW_VALUE_SIZE` bigint(21)
,`DATA_BLOCK_SIZE` bigint(21)
,`INDEX_BLOCK_SIZE` bigint(21)
,`INDEX_PARTITIONS` int(11)
,`TOP_LEVEL_INDEX_SIZE` bigint(21)
,`FILTER_BLOCK_SIZE` bigint(21)
,`COMPRESSION_ALGO` varchar(193)
,`CREATION_TIME` bigint(21)
,`FILE_CREATION_TIME` bigint(21)
,`OLDEST_KEY_TIME` bigint(21)
,`FILTER_POLICY` varchar(193)
,`COMPRESSION_OPTIONS` varchar(193)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `ROCKSDB_TRX`
-- (See below for the actual view)
--
CREATE TABLE `ROCKSDB_TRX` (
`TRANSACTION_ID` bigint(21)
,`STATE` varchar(193)
,`NAME` varchar(193)
,`WRITE_COUNT` bigint(21)
,`LOCK_COUNT` bigint(21)
,`TIMEOUT_SEC` int(11)
,`WAITING_KEY` varchar(513)
,`WAITING_COLUMN_FAMILY_ID` int(11)
,`IS_REPLICATION` int(11)
,`SKIP_TRX_API` int(11)
,`READ_ONLY` int(11)
,`HAS_DEADLOCK_DETECTION` int(11)
,`NUM_ONGOING_BULKLOAD` int(11)
,`THREAD_ID` int(11)
,`QUERY` varchar(193)
);
...
--
-- Stand-in structure for view `SEQUENCES`
-- (See below for the actual view)
--
CREATE TABLE `SEQUENCES` (
`SEQUENCE_CATALOG` varchar(512)
,`SEQUENCE_SCHEMA` varchar(64)
,`SEQUENCE_NAME` varchar(64)
,`DATA_TYPE` varchar(64)
,`NUMERIC_PRECISION` int(21)
,`NUMERIC_PRECISION_RADIX` int(21)
,`NUMERIC_SCALE` int(21)
,`START_VALUE` decimal(21,0)
,`MINIMUM_VALUE` decimal(21,0)
,`MAXIMUM_VALUE` decimal(21,0)
,`INCREMENT` bigint(21)
...
--
-- Stand-in structure for view `SLAVE_STATUS`
-- (See below for the actual view)
--
CREATE TABLE `SLAVE_STATUS` (
`Connection_name` varchar(64)
,`Slave_SQL_State` varchar(64)
,`Slave_IO_State` varchar(64)
,`Master_Host` varchar(255)
,`Master_User` varchar(384)
,`Master_Port` smallint(5) unsigned
,`Connect_Retry` int(10) unsigned
,`Master_Log_File` varchar(512)
,`Read_Master_Log_Pos` bigint(20) unsigned
,`Relay_Log_File` varchar(512)
,`Relay_Log_Pos` bigint(20) unsigned
,`Relay_Master_Log_File` varchar(512)
,`Slave_IO_Running` varchar(10)
,`Slave_SQL_Running` varchar(3)
,`Replicate_Do_DB` varchar(21844)
,`Replicate_Ignore_DB` varchar(21844)
,`Replicate_Do_Table` varchar(21844)
,`Replicate_Ignore_Table` varchar(21844)
,`Replicate_Wild_Do_Table` varchar(21844)
,`Replicate_Wild_Ignore_Table` varchar(21844)
,`Last_Errno` smallint(4) unsigned
,`Last_Error` varchar(1024)
,`Skip_Counter` int(10) unsigned
,`Exec_Master_Log_Pos` bigint(20) unsigned
,`Relay_Log_Space` bigint(20) unsigned
,`Until_Condition` varchar(6)
,`Until_Log_File` varchar(512)
,`Until_Log_Pos` bigint(20) unsigned
,`Master_SSL_Allowed` varchar(7)
,`Master_SSL_CA_File` varchar(512)
,`Master_SSL_CA_Path` varchar(512)
,`Master_SSL_Cert` varchar(512)
,`Master_SSL_Cipher` varchar(512)
,`Master_SSL_Key` varchar(512)
,`Seconds_Behind_Master` bigint(20) unsigned
,`Master_SSL_Verify_Server_Cert` varchar(3)
,`Last_IO_Errno` smallint(4) unsigned
,`Last_IO_Error` varchar(1024)
,`Last_SQL_Errno` smallint(4) unsigned
,`Last_SQL_Error` varchar(1024)
,`Replicate_Ignore_Server_Ids` varchar(21844)
,`Master_Server_Id` int(10) unsigned
,`Master_SSL_Crl` varchar(512)
,`Master_SSL_Crlpath` varchar(512)
,`Using_Gtid` varchar(11)
,`Gtid_IO_Pos` varchar(21844)
,`Replicate_Do_Domain_Ids` varchar(21844)
,`Replicate_Ignore_Domain_Ids` varchar(21844)
,`Parallel_Mode` varchar(12)
,`SQL_Delay` int(10) unsigned
,`SQL_Remaining_Delay` int(10) unsigned
,`Slave_SQL_Running_State` varchar(21844)
,`Slave_DDL_Groups` bigint(20) unsigned
,`Slave_Non_Transactional_Groups` bigint(20) unsigned
,`Slave_Transactional_Groups` bigint(20) unsigned
,`Replicate_Rewrite_DB` varchar(21844)
,`Retried_transactions` int(10) unsigned
,`Max_relay_log_size` int(10) unsigned
,`Executed_log_entries` int(10) unsigned
,`Slave_received_heartbeats` int(10) unsigned
,`Slave_heartbeat_period` float(9,3)
,`Gtid_Slave_Pos` varchar(21844)
,`Master_last_event_time` datetime
,`Slave_last_event_time` datetime
,`Master_Slave_time_diff` int(10) unsigned
);
...
,`KEY_READ_HITS` bigint(21)
,`KEY_READ_MISSES` bigint(21)
,`PAGES_ACCESSED` bigint(21)
,`PAGES_READ_FROM_DISK` bigint(21)
);
...
CREATE TEMPORARY TABLE `CLIENT_STATISTICS` (
  ...
  `KEY_READ_HITS` bigint(21) NOT NULL,
  `KEY_READ_MISSES` bigint(21) NOT NULL,
...
--
-- Structure for view `KEY_PERIOD_USAGE`
--
DROP TABLE IF EXISTS `KEY_PERIOD_USAGE`;

CREATE TEMPORARY TABLE `KEY_PERIOD_USAGE` (
  `CONSTRAINT_CATALOG` varchar(512) NOT NULL,
  `CONSTRAINT_SCHEMA` varchar(64) NOT NULL,
  `CONSTRAINT_NAME` varchar(64) NOT NULL,
  `TABLE_CATALOG` varchar(512) NOT NULL,
...
--
-- Structure for view `OPTIMIZER_COSTS`
--
DROP TABLE IF EXISTS `OPTIMIZER_COSTS`;
...
--
-- Structure for view `ROCKSDB_CFSTATS`
--
DROP TABLE IF EXISTS `ROCKSDB_CFSTATS`;

CREATE TEMPORARY TABLE `ROCKSDB_CFSTATS` (
...
--
-- Structure for view `ROCKSDB_CF_OPTIONS`
--
DROP TABLE IF EXISTS `ROCKSDB_CF_OPTIONS`;

CREATE TEMPORARY TABLE `ROCKSDB_CF_OPTIONS` (
  `CF_NAME` varchar(193) NOT NULL,
...
--
-- Structure for view `ROCKSDB_COMPACTION_STATS`
--
DROP TABLE IF EXISTS `ROCKSDB_COMPACTION_STATS`;
...
--
-- Structure for view `ROCKSDB_DBSTATS`
--
DROP TABLE IF EXISTS `ROCKSDB_DBSTATS`;
...
--
-- Structure for view `ROCKSDB_DDL`
--
DROP TABLE IF EXISTS `ROCKSDB_DDL`;

CREATE TEMPORARY TABLE `ROCKSDB_DDL` (
...
--
-- Structure for view `ROCKSDB_DEADLOCK`
--
DROP TABLE IF EXISTS `ROCKSDB_DEADLOCK`;
...
--
-- Structure for view `ROCKSDB_GLOBAL_INFO`
--
DROP TABLE IF EXISTS `ROCKSDB_GLOBAL_INFO`;

CREATE TEMPORARY TABLE `ROCKSDB_GLOBAL_INFO` (
  `TYPE` varchar(513) NOT NULL,
...
--
-- Structure for view `ROCKSDB_INDEX_FILE_MAP`
--
DROP TABLE IF EXISTS `ROCKSDB_INDEX_FILE_MAP`;

CREATE TEMPORARY TABLE `ROCKSDB_INDEX_FILE_MAP` (
  `COLUMN_FAMILY` int(11) NOT NULL,
  `INDEX_NUMBER` int(11) NOT NULL,
...
--
-- Structure for view `ROCKSDB_LOCKS`
--
DROP TABLE IF EXISTS `ROCKSDB_LOCKS`;
...
--
-- Structure for view `ROCKSDB_PERF_CONTEXT`
--
DROP TABLE IF EXISTS `ROCKSDB_PERF_CONTEXT`;

CREATE TEMPORARY TABLE `ROCKSDB_PERF_CONTEXT` (
  `TABLE_SCHEMA` varchar(193) NOT NULL,
  `TABLE_NAME` varchar(193) NOT NULL,
  `PARTITION_NAME` varchar(193),
  `STAT_TYPE` varchar(193) NOT NULL,
...
--
-- Structure for view `ROCKSDB_PERF_CONTEXT_GLOBAL`
--
DROP TABLE IF EXISTS `ROCKSDB_PERF_CONTEXT_GLOBAL`;

CREATE TEMPORARY TABLE `ROCKSDB_PERF_CONTEXT_GLOBAL` (
  `STAT_TYPE` varchar(193) NOT NULL,
  `VALUE` bigint(21) NOT NULL
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Structure for view `ROCKSDB_SST_PROPS`
--
DROP TABLE IF EXISTS `ROCKSDB_SST_PROPS`;

CREATE TEMPORARY TABLE `ROCKSDB_SST_PROPS` (
  `SST_NAME` varchar(193) NOT NULL,
  `COLUMN_FAMILY` int(11) NOT NULL,
...
--
-- Structure for view `ROCKSDB_TRX`
--
DROP TABLE IF EXISTS `ROCKSDB_TRX`;

CREATE TEMPORARY TABLE `ROCKSDB_TRX` (
  `TRANSACTION_ID` bigint(21) NOT NULL,
...
--
-- Structure for view `SEQUENCES`
--
DROP TABLE IF EXISTS `SEQUENCES`;

CREATE TEMPORARY TABLE `SEQUENCES` (
  `SEQUENCE_CATALOG` varchar(512) NOT NULL,
  `SEQUENCE_SCHEMA` varchar(64) NOT NULL,
  `SEQUENCE_NAME` varchar(64) NOT NULL,
  `DATA_TYPE` varchar(64) NOT NULL,
  `NUMERIC_PRECISION` int(21) NOT NULL,
  `NUMERIC_PRECISION_RADIX` int(21),
  `NUMERIC_SCALE` int(21),
  `START_VALUE` decimal(21,0) NOT NULL,
  `MINIMUM_VALUE` decimal(21,0) NOT NULL,
  `MAXIMUM_VALUE` decimal(21,0) NOT NULL,
  `INCREMENT` bigint(21) NOT NULL,
  `CYCLE_OPTION` varchar(3) NOT NULL
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
--
-- Structure for view `SLAVE_STATUS`
--
DROP TABLE IF EXISTS `SLAVE_STATUS`;

CREATE TEMPORARY TABLE `SLAVE_STATUS` (
  ...
  `Master_Log_File` varchar(512) NOT NULL,
  `Read_Master_Log_Pos` bigint(20) UNSIGNED NOT NULL,
  `Relay_Log_File` varchar(512) NOT NULL,
  `Relay_Log_Pos` bigint(20) UNSIGNED NOT NULL,
  `Relay_Master_Log_File` varchar(512) NOT NULL,
  `Slave_IO_Running` varchar(10) NOT NULL,
  `Slave_SQL_Running` varchar(3) NOT NULL,
  `Replicate_Do_DB` varchar(21844) NOT NULL,
  `Replicate_Ignore_DB` varchar(21844) NOT NULL,
  `Replicate_Do_Table` varchar(21844) NOT NULL,
  `Replicate_Ignore_Table` varchar(21844) NOT NULL,
  `Replicate_Wild_Do_Table` varchar(21844) NOT NULL,
  `Replicate_Wild_Ignore_Table` varchar(21844) NOT NULL,
  `Last_Errno` smallint(4) UNSIGNED NOT NULL,
  `Last_Error` varchar(1024),
  `Skip_Counter` int(10) UNSIGNED NOT NULL,
  `Exec_Master_Log_Pos` bigint(20) UNSIGNED NOT NULL,
  `Relay_Log_Space` bigint(20) UNSIGNED NOT NULL,
  `Until_Condition` varchar(6) NOT NULL,
  `Until_Log_File` varchar(512),
  `Until_Log_Pos` bigint(20) UNSIGNED NOT NULL,
  `Master_SSL_Allowed` varchar(7),
  `Master_SSL_CA_File` varchar(512),
  `Master_SSL_CA_Path` varchar(512),
  `Master_SSL_Cert` varchar(512),
  ...
  `Master_SSL_Key` varchar(512),
  `Seconds_Behind_Master` bigint(20) UNSIGNED,
  `Master_SSL_Verify_Server_Cert` varchar(3) NOT NULL,
  `Last_IO_Errno` smallint(4) UNSIGNED NOT NULL,
  `Last_IO_Error` varchar(1024),
  `Last_SQL_Errno` smallint(4) UNSIGNED NOT NULL,
  `Last_SQL_Error` varchar(1024),
  `Replicate_Ignore_Server_Ids` varchar(21844) NOT NULL,
  `Master_Server_Id` int(10) UNSIGNED NOT NULL,
  `Master_SSL_Crl` varchar(512),
  `Master_SSL_Crlpath` varchar(512),
  `Using_Gtid` varchar(11),
  `Gtid_IO_Pos` varchar(21844) NOT NULL,
  `Replicate_Do_Domain_Ids` varchar(21844) NOT NULL,
  `Replicate_Ignore_Domain_Ids` varchar(21844) NOT NULL,
  `Parallel_Mode` varchar(12) NOT NULL,
  `SQL_Delay` int(10) UNSIGNED NOT NULL,
  `SQL_Remaining_Delay` int(10) UNSIGNED,
  `Slave_SQL_Running_State` varchar(21844),
  `Slave_DDL_Groups` bigint(20) UNSIGNED NOT NULL,
  `Slave_Non_Transactional_Groups` bigint(20) UNSIGNED NOT NULL,
  `Slave_Transactional_Groups` bigint(20) UNSIGNED NOT NULL,
  `Replicate_Rewrite_DB` varchar(21844) NOT NULL,
  `Retried_transactions` int(10) UNSIGNED NOT NULL,
  `Max_relay_log_size` int(10) UNSIGNED NOT NULL,
  `Executed_log_entries` int(10) UNSIGNED NOT NULL,
  `Slave_received_heartbeats` int(10) UNSIGNED NOT NULL,
  `Slave_heartbeat_period` float(9,3) NOT NULL,
  `Gtid_Slave_Pos` varchar(21844) NOT NULL,
  `Master_last_event_time` datetime,
  `Slave_last_event_time` datetime,
  `Master_Slave_time_diff` int(10) UNSIGNED
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TEMPORARY TABLE `TABLE_STATISTICS` (
  ...
  `KEY_READ_HITS` bigint(21) NOT NULL,
  `KEY_READ_MISSES` bigint(21) NOT NULL,
  `PAGES_ACCESSED` bigint(21) NOT NULL,
  `PAGES_READ_FROM_DISK` bigint(21) NOT NULL
) ENGINE=MEMORY DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
